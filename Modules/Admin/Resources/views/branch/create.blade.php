                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    {!! Form::open(array('route' => 'area.branch.store','method'=>'POST','class'=>'','files'=>true)) !!}
                                ...
                                <div class="row pt-3">
                                    <div class="col-md-6 offset-md-3">
                                        <button type="submit" class="btn btn-primary"><i class="la la-check"></i>&nbsp;Save Branch</button>
                                        @can('user-list')
