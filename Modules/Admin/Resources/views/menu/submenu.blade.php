...
<div class="content">
    <div class="container-fluid">
        ...
        @include('components.breadcrumb', ['item' => ['/dashboard'=>env('APP_NAME'),'active'=>'ACL'],
        'pTitle' => 'Menu Edit'])
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('acl.menu.index')}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Menu List"> <i class="mdi mdi-text me-1"></i>Main Menu Lists</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-1">
                                            <label for="example-text-input" class="col-form-label text-right">Permission</label>
                                        </div>
                                        <div class="col-11">
                                    ...
                                    <hr>
                                    <div class="row justify-content-md-center justify-content-lg-center table-responsive">
                                            ...
                                            <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><i class="{{($data->status==App\Models\Menu\SubMenu::ACTIVE)? 'mdi mdi-check-circle text-success' : 'mdi mdi-alert-circle-check text-danger'}}"></i></td>

                                                        <td>{{$data->created_at}}</td>
                                                        <td>
                                                            {!! Form::open(array('route' => ['acl.sub-menu.destroy',$data->id],'method'=>'DELETE','id'=>"deleteForm$data->id")) !!}
                                                            <a href="{{route('acl.sub-menu.edit',$data->id)}}" class="btn btn-success btn-sm"><i class="mdi mdi-pencil-box"></i> </a>
