                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('acl.sub-menu.show',$data->menu_id)}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Submenu List"> <i class="mdi mdi-text me-1"></i>Submenu List</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mt-2 {{ $errors->has('name') ? 'has-error' : '' }}">
                                        <div class="col-md-1">
                                            {{Form::label('name', ' Sub Menu', array('class' => ' control-label text-right'))}} <strong><span class="text-danger">&nbsp;*</span></strong>
                                        </div>
                                        <div class="col-md-11">
