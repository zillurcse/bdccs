                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('acl.roles.index')}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Role List"> <i class="mdi mdi-text me-1"></i>Role Lists</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    {!! Form::model($role, ['method' => 'PATCH','route' => ['acl.roles.update', $role->id],'class'=>'kt-form kt-form--label-right']) !!}
