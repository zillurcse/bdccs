                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('acl.users.index')}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Users List"> <i class="mdi mdi-text me-1"></i>Users Lists</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input id="file" style="display:none" name="avater" type="file" onchange="photoLoad(this,this.id)" accept="image/*">


                                            @if ($errors->has('avater'))
                                            <span class="help-block">
                                                <strong class="text-danger">{{ $errors->first('avater') }}</strong>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
