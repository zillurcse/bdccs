...
{{--                                            <a href="{{route('applications.import')}}" class="btn btn-success mb-2 me-2" data-toggle="tooltip" title="Import Application"> <i class="mdi mdi-microsoft-excel me-1"></i>Import Application</a>--}}
                                            <a href="{{route('bdcs-code.create')}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Add New Code"> <i class="mdi mdi-plus me-1"></i>New Code</a>
                                        @endcan
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-info">
                    <h4 class="modal-title " id="myLargeModalLabel">BDCS CODE Details</h4>
...
@section('javascript')
    ...
    <script>
        function showApplicationDetails(id) {
            $('#dataBody').empty().load('{{URL::to(Request()->route()->getPrefix()."/bdcs-code")}}/'+id);
