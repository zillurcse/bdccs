                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="javascript:void(0)" class="btn btn-success mb-2 me-2" data-toggle="tooltip" title="Add New Permission" id="addPermissionBtn"> <i class="mdi mdi-plus me-1"></i>Add New Permission</a>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade permission" id="permissionModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h4 class="modal-title " id="myLargeModalLabel">Add New Permission</h4>
   ...
   <script>
    $(function() {
        $('#dataTable').DataTable( {
            ...
            ajax: '{{ URL::to("admin/acl/permission/create") }}',
            columns: [
