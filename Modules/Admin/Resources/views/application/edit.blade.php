                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mt-2">
                                        <label for="example-text-input" class="col-2 col-form-label text-right"><strong>SL <span class="text-danger">*</span></strong></label>
                                        <div class="col-6">
                                    ...
                                    <div class="form-group row mt-2">
                                        <label for="example-text-input" class="col-2 col-form-label text-right"><strong>R.F Embassy</strong></label>
                                        <div class="col-6">
                                            {!! Form::date('rf_embassy', $value=old('rf_embassy'), array('placeholder' => 'R.F Embassy','class' => 'form-control','id'=>'rf_embassy')) !!}
                                    ...
                                    <div class="form-group row mt-2">
                                        ...
                                        <div class="col-6">
                                            {!! Form::text('submit_serial_no', $value=old('submit_serial_no'), array('placeholder' => 'Submit Serial NO','class' => 'form-control','required'=>true,'id'=>'serial_no')) !!}
