...
<div class="content">
    <div class="container-fluid">
        @include('components.breadcrumb', ['item' => ['/'=>'Pocket Money','active'=>'ACL'],
        'pTitle' => 'Users'])
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-4">
                                <div class="text-xl-end mt-xl-0 mt-2">
                                    <a href="{{route('acl.users.create')}}" class="btn btn-info mb-2 me-2" data-toggle="tooltip" title="Add New User"> <i class="mdi mdi-plus me-1"></i>Add New User</a>
