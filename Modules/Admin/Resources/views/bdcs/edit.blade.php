                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-xl-4">
                                    <div class="text-xl-end mt-xl-0 mt-2">
                                        <a href="{{route('bdcs-code.index')}}" class="btn btn-info mb-2 me-2"
                                           data-toggle="tooltip" title="BDCS CODE List"> <i
                                                class="mdi mdi-text me-1"></i>BDCS CODE Lists</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        {!! Form::model($seller,array('route' => ['bdcs-code.update',$seller->id],'method'=>'PUT','class'=>'','files'=>true)) !!}
                                        <div class="form-group row mt-2">
                                            <h1>BDCS- {{$seller->code}}</h1>
                                        </div>
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>BDCS Code <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                                {!! Form::text('code', $value=old('code'), array('placeholder' => $seller->code,'class' => 'form-control','readonly'=>true,'id'=>'code')) !!}
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Business name <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                                ...
                                                <strong
                                                    class="text-danger">{{ $errors->first('business_name') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Issue Date <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Expire Date <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Name <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Address <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('seller_address'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('seller_address') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Phone <span
                                                        class="text-danger">*</span></strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('seller_phone'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('seller_phone') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Email</strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('seller_email'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('seller_email') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Nid Number
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Trade License
                                                    Number </strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('seller_trade_license'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('seller_trade_license') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Seller Tin
                                                    Number </strong></label>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>Business Mobile
                                                    No</strong></label>
                                            <div class="col-6">
                                                ...
                                                @if ($errors->has('business_phone'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('business_phone') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-3 col-form-label text-right"><strong>Seller Photo</strong></label>
                                            <div class="col-6">
                                                ...
                                                <input id="file" style="display:none" name="seller_photo" type="file"
                                                       onchange="photoLoad(this,this.id)" accept="image/*">
                                                @if ($errors->has('seller_photo'))
                                                    <span class="help-block">
                                                <strong
                                                    class="text-danger">{{ $errors->first('seller_photo') }}</strong>
                                            </span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="example-text-input"
                                                   class="col-2 col-form-label text-right"><strong>NID
                                                    File</strong></label>
                                            <div class="col-6">
                                        ...
                                        <div class="row pt-3">
                                            <div class="col-md-6 offset-md-3">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="la la-check"></i>&nbsp;Update seller
                                                </button>
                                                @can('application-list')
                                                    <a href="{{route('bdcs-code.index')}}" class="btn btn-danger"><i
